...
class ModelDrawer:
    ...
    def draw_points(self, model_config):
        self.draw_stationary_nodes(model_config.stationary_nodes)
        self.draw_mobile_node(model_config.mobile_node)
